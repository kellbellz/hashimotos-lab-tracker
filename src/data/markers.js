...
export const MARKERS = [
  ...
  },
  {
    ...
    unit: 'ng/dL',
    category: 'thyroid',
    aliases: ['free t4', 'ft4', 'free thyroxine', 't4 free', 't4 free direct', 't4,free', 'thyroxine t4 free'],
  ...
  },
  {
    ...
    unit: 'pg/mL',
    category: 'thyroid',
    aliases: ['triiodothyronine t3 free', 'triiodothyronine free', 'free t3', 'ft3', 'free triiodothyronine', 't3 free', 't3, free'],
  ...
  },
  {
    ...
    unit: 'IU/mL',
    category: 'antibodies',
    aliases: ['tpo', 'anti-tpo', 'thyroid peroxidase', 'tpo antibodies', 'antithyroid peroxidase', 'anti tpo ab', 'tpo ab'],
  ...
  },
  {
    ...
    unit: 'IU/mL',
    category: 'antibodies',
    aliases: ['thyroglobulin antibody', 'tg ab', 'anti-tg', 'thyroglobulin antibodies', 'tgab', 'tg antibodies', 'antithyroglobulin'],
  ...
  },
  {
    ...
    unit: 'ng/mL',
    category: 'nutrients',
    aliases: ['vitamin d 25 hydroxy', '25 hydroxy vitamin d', 'vitamin d 25-hydroxy', 'vitamin d', '25-oh vitamin d', 'vit d', 'vitamin d3', '25 oh vitamin d', '25(oh)d', '25-hydroxyvitamin d'],
  ...
  },
  {
    ...
    unit: 'pg/mL',
    category: 'nutrients',
    aliases: ['b12', 'vitamin b12', 'cobalamin', 'vit b12'],
  ...
  },
  {
    ...
    aliases: ['crp', 'c-reactive protein', 'hs-crp', 'hsCRP', 'high sensitivity crp', 'hs crp'],
